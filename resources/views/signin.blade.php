                    ...
                    <div class="box cards is-centered">
                        <form method="post"action="{{url('index')}}">
                          ...
                          <div class="field">
                            ...
                            <div class="control">
                              <input class="input is-success" name="username" type="text" placeholder="Enter a username" value="{{old('username')}}">
                                <span class="text-danger">@error('username') {{$username}} @enderror</span>
                            </div>
                          </div>
                          <div class="field">
                            <label class="label has-text-white">Password</label>
                            <div class="control">
                              <input class="input is-danger" name="password" type="password" placeholder="Enter your password">
                                <span class="text-danger">@error('password') {{$password}} @enderror</span>
                            </div>
                          </div>
                          ...
                          <div class="field is-grouped is-flex is-justify-content-center">
                            <div class="control">
                              <button class="button signup" type="submit">Log In</button>
                            </div>
                            </div>
                        </form>
                          </div>
