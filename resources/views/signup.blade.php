            ...
            <div class="column is-flex-direction-column is-justify-content-center is-align-items-center">
                ...
                <form method="post">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input is-danger" name="email" type="email" placeholder="Enter your email" value="{{old('email')}}">
                            <span class="has-text-danger">@error('email') {{$message}} @enderror</span>
                    ...
                    <div class="field">
                       ...
                       <!-- <p class="help is-danger">Please create a strong password</p> -->
                    </div>
                    <div class="field">
                    ...
                    <div class="field">
                        <div class="control is-flex-direction-column is-justify-content-center is-align-items-center">
                            <button class="button has-text-weight-bold" type="submit" style="background-color: #fa0035;border: none; color: #FFFFFF;">Sign Up</button>
                            <a href="./signin" class="is-link is-block terms m-3">Already a User ? , Sign In</a>
